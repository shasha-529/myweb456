...
func=>run() {
  if(event.keyCode == 13) {
    ...
    if (a == 'list' || a == 'a*help') {
      ...
      '<e>"hack_sololearn"</e> to hack SoloLearn server<br>'+
    ...
    ;; If Command Is Creator
      ...
      'Created by: <e>Amethyst Animion</e><br>'+
      'Created on: <e>14 June 2018</e><br>'+
    ...
    elif (a == 'hack_sololearn' || a == 'a*hack') {
      hack();
    }
    ;; If Command Is Error
    elif (a == 'error' || a == 'a*e') {
...
func=>hack() {
  ...
  hackText = 'I_n_i_t_i_a_l_i_z_i_n_g_._._._<br>'+
    ...
    '_Username_:_ _<e>SoloLearn</e>_<br>'+
